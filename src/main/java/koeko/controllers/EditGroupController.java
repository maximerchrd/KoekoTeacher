    ...
    public void saveGroup() {
        if (groupIndex >= 0) {
            ...
            for (HBox hBox : hBoxArrayList) {
                ...
                Student studentObject = Koeko.studentGroupsAndClass.get(groupIndex).getStudentWithName(student);
                Koeko.studentGroupsAndClass.get(groupIndex).addStudentIfNotInClass(studentObject);
            }
        }
